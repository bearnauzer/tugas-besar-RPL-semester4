...
if (isset($_POST['submit'])) {
    ...
    if ($error === 0) {
        ...
        if (in_array($ekstensi_file, $ekstensi_valid)) {
            ...
            $path_db = 'assets/uploads/' . $nama_file_baru;
            move_uploaded_file($tmp_name, $lokasi_simpan);
        } else {
            echo "<script>alert('Yang Anda upload bukan gambar valid (hanya JPG/PNG)!');</script>";
        }
    }

    $query = "INSERT INTO produk_collection (nama, deskripsi, harga_dasar, kategori, tipe, gambar, foto, stok) 
            VALUES ('$nama', '$deskripsi', '$harga_dasar', '$kategori', '$tipe', '$path_db', '$path_db', '$stok')";
...
<head>
    ...
    <title>Tambah Koleksi Produk - PERSCENTS</title>
    ...
    <style>
        ...
        .file-info { font-size: 12px; color: #A3AED0; margin-top: 8px; display: block; }
    </style>
</head>
<body>
    ...
    <main class="main-wrapper">
        <header class="topbar">
            <h1 class="page-title">Tambah Koleksi Produk</h1>
...
<div class="form-group">
    ...
    <input type="text" name="nama" class="form-control" placeholder="Contoh: INTJ - The Architect" required>
</div>

<div class="form-group">
    <label>Deskripsi Produk</label>
    <textarea name="deskripsi" class="form-control" placeholder="Tuliskan deskripsi notes aroma atau karakteristik parfum..."></textarea>
</div>
...
<div class="grid-2" style="margin-bottom: 0;">
    ...
    <div class="form-group">
        <label>Tipe Katalog</label>
        <select name="tipe" class="form-control" required>
            <option value="mbti">MBTI</option>
            <option value="karakter">Karakter Kucing</option>
        </select>
    </div>
</div>
...
<div class="grid-2" style="margin-bottom: 0;">
    <div class="form-group">
        ...
        <input type="number" name="harga_dasar" class="form-control" value="150000" required>
    </div>
    <div class="form-group">
        <label>Stok Awal</label>
        <input type="number" name="stok" class="form-control" value="100" required>
    </div>
</div>

<div class="form-group">
    <label>Upload Gambar / Foto Produk</label>
    <input type="file" name="gambar" class="form-control" accept="image/png, image/jpeg, image/jpg" style="padding: 10px;">
    <span class="file-info"><i class="fa-solid fa-circle-info"></i> Format: JPG, JPEG, PNG. Opsional (bisa dikosongkan).</span>
</div>

                <button type="submit" name="submit" class="btn-primary" style="width: 100%; justify-content: center; padding: 14px; font-size: 16px; margin-top: 10px;"><i class="fa-solid fa-floppy-disk"></i> Simpan Data</button>
            </form>
        </div>
    </main>
</body>
