...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO notes_aroma_custom (nama, deskripsi, kategori, harga) 
             VALUES ('$nama', '$deskripsi', '$kategori', '$harga')";

    if (mysqli_query($conn, $query)) {
        echo "<script>
                alert('Data notes aroma berhasil ditambahkan!');
...
<head>
    ...
    <title>Tambah Notes Aroma - PERSCENTS</title>
...
<body>
    ...
    <main class="main-wrapper">
        <header class="topbar">
            <h1 class="page-title">Tambah Notes Aroma</h1>
...
<div class="form-group">
    <label>Nama Notes Aroma</label>
    <input type="text" name="nama" class="form-control" placeholder="Contoh: Vanilla / Citrus / Sandalwood" required>
</div>
<div class="form-group">
    <label>Deskripsi Notes (Opsional)</label>
    <textarea name="deskripsi" class="form-control" placeholder="Tuliskan deskripsi singkat karakter aroma ini..."></textarea>
</div>
<div class="grid-2" style="margin-bottom: 0;">
    ...
    <div class="form-group">
        <label>Harga Tambahan Custom (Rp)</label>
