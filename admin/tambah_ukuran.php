...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO mst_ukuran (nama, ml, tambahan_harga) 
            VALUES ('$nama', '$ml', '$tambahan_harga')";

    if (mysqli_query($conn, $query)) {
        echo "<script>
                alert('Data ukuran botol berhasil ditambahkan!');
                window.location.href = 'variant_management.php';
            </script>";
    } else {
...
<head>
    ...
    <title>Tambah Ukuran Botol - PERSCENTS</title>
...
<body>
    ...
    <main class="main-wrapper">
        <header class="topbar">
            <h1 class="page-title">Tambah Ukuran Botol</h1>
...
<div class="form-group">
    <label>Nama Ukuran (Contoh: Medium / Large)</label>
    <input type="text" name="nama" class="form-control" placeholder="Contoh: Medium" required>
</div>
<div class="form-group">
    <label>Volume Botol (ml)</label>
    <input type="number" name="ml" class="form-control" placeholder="Contoh: 50" required>
</div>
<div class="form-group">
    <label>Tambahan Harga (Rp)</label>
    <input type="number" name="tambahan_harga" class="form-control" value="0" required>
</div>
