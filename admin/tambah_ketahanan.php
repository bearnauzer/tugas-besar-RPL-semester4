...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO mst_ketahanan (nama, durasi, tambahan_harga) 
            VALUES ('$nama', '$durasi', '$tambahan_harga')";

    if (mysqli_query($conn, $query)) {
        echo "<script>
                alert('Data ketahanan berhasil ditambahkan!');
...
<head>
    ...
    <title>Tambah Ketahanan Aroma - PERSCENTS</title>
...
<body>
    ...
    <main class="main-wrapper">
        <header class="topbar">
            <h1 class="page-title">Tambah Ketahanan Aroma</h1>
...
<div class="form-group">
    <label>Nama Tipe Ketahanan</label>
    <input type="text" name="nama" class="form-control" placeholder="Contoh: EDP (Eau de Parfum)" required>
</div>
<div class="form-group">
    <label>Estimasi Durasi</label>
    <input type="text" name="durasi" class="form-control" placeholder="Contoh: 8 - 12 Jam" required>
</div>
<div class="form-group">
